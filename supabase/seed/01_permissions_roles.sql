...
insert into public.permissions (key, module, action, name_ar, is_sensitive) values
  ...
  ('organizations.branches.delete', 'organizations', 'branches.delete', 'حذف فرع', true),
  ...
  ('organizations.departments.delete', 'organizations', 'departments.delete', 'حذف قسم', true),
  ...
  ('services.delete', 'services', 'delete', 'حذف خدمة', true),
  ...
  ('services.providers.delete', 'services', 'providers.delete', 'حذف مقدّم خدمة', true),
  ...
  ('appointments.delete', 'appointments', 'delete', 'حذف حجز', true),
