...
export const PENDING_RULES: readonly PendingRule[] = [
  ...
  },
  {
    id: 'P-11',
    module: 'appointments',
    description: 'حالات الحجز النهائية وانتقالاتها',
    blockingQuestion: 'ما الحالات المستخدمة فعليًا اليوم وما الانتقالات المسموحة؟',
  },
  {
    id: 'P-12',
    module: 'appointments',
    description: 'قواعد منع تعارض المواعيد',
    blockingQuestion: 'هل يُمنع حجزان لنفس الموظف في نفس الوقت؟',
  },
  {
    id: 'P-13',
    module: 'appointments',
