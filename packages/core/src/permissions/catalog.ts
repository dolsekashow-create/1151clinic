...
export const PERMISSIONS: readonly PermissionDefinition[] = [
  ...
  /*
    ...
    ⚠️ لا صلاحية لتسجيل حضور **الذات**: كل موظف يسجّل دخوله وخروجه بلا شرط،
       تمامًا كما يقرأ ملفه الشخصي. اشتراط صلاحية هنا يعني أن موظفًا جديدًا
       لا يستطيع إثبات حضوره حتى يمنحه أحد صلاحية — وهو تعطيل بلا مقابل أمني،
       فالحماية الحقيقية هي النطاق الجغرافي لا الصلاحية.
    ⚠️ `manage` حسّاسة: تصحيح سجل حضور يغيّر ساعات موظف، ومن يملكها لا يستطيع
       تصحيح سجل نفسه (مفروض في سياسة قاعدة البيانات).
  */
  ...define('attendance', [
    ['view', 'عرض سجل حضور الموظفين'],
    ['manage', 'تصحيح سجلات الحضور', true],
  ]),
