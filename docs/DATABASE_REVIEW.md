...
| **يحتاج Migration؟** | ✅ `20260817007000_security_hardening.sql` |
...
| 7 | `20260817006000_notifications_files_audit` | 2، 3 (`customers`، `profiles`) | ✅ |
| 8 | `20260817007000_security_hardening` | 2–7 (يعدّل ما سبق) | ✅ |
