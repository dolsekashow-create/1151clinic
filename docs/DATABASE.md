...
>
> ✅ **الترحيلات الثمانية مُطبَّقة على بيئة التطوير/الاختبار** (`axtezcgdkdkdyflbdndv`)
> ومُتحقَّق منها على الكتالوج البعيد: 42 جدولًا بـRLS · 126 سياسة · 16 دالة · 40 محفّزًا · 181 فهرسًا.
> راجع [DEPLOYMENT.md](./DEPLOYMENT.md) §2.1 · لا توجد بيئة Production بعد.
...
| `20260817060000_notifications_files_audit.sql` | الإشعارات، الملفات، سجل التدقيق، طبقة التكامل |
